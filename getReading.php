...
if ($db->connect_errno > 0) {
    ...
    if ($type == "lastHour") {
        ...
        // RAIN + DAM
        $sql = "select distinct date_created,SUM(elster) as average_elster from elster_readings where `date_created` >= DATE_SUB( NOW(), INTERVAL 1 HOUR ) AND `date_created` <= NOW()  group by DATE(date_created), HOUR(date_created)";
        ...
        $sql = "select distinct date_created,SUM(elster) as average_elster from elster_readings where `date_created` >= DATE_SUB( NOW(), INTERVAL 1 DAY ) AND `date_created` <= NOW()  group by DATE(date_created), HOUR(date_created)";
        ...
        $sql = "select distinct date_created,SUM(elster) as average_elster from elster_readings where `date_created` >= DATE_SUB( NOW(), INTERVAL 7 DAY ) AND `date_created` <= NOW()  group by DATE(date_created), HOUR(date_created)";
        ...
        $sql = "select distinct date_created,SUM(elster) as average_elster from elster_readings where `date_created` >= DATE_SUB( NOW(), INTERVAL 30 DAY ) AND `date_created` <= NOW()  group by DATE(date_created), HOUR(date_created)";
